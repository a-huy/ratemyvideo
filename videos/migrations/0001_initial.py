...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('videos_video', (
            ...
            ('yt_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=11)),
        ...
        db.send_create_signal('videos', ['Rating'])
        ...
        db.create_table('videos_question', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('modified_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('deleted_date', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True)),
        ...
        db.send_create_signal('videos', ['Question'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('videos_rating')

        # Deleting model 'Vote'
        db.delete_table('videos_vote')

        # Deleting model 'Question'
        db.delete_table('videos_question')
