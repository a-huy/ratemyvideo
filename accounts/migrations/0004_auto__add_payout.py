...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Payout'
        db.create_table('accounts_payout', (
            ...
            ('amount', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=5, decimal_places=2)),
        ))
        db.send_create_signal('accounts', ['Payout'])


    def backwards(self, orm):
        # Deleting model 'Payout'
        db.delete_table('accounts_payout')
