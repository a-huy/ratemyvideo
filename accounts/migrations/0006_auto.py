...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Payout', fields ['deleted_date']
        db.create_index('accounts_payout', ['deleted_date'])

        # Adding index on 'UserWhitelist', fields ['deleted_date']
        db.create_index('accounts_userwhitelist', ['deleted_date'])

        # Adding index on 'InviteRequest', fields ['deleted_date']
        db.create_index('accounts_inviterequest', ['deleted_date'])

        # Adding index on 'User', fields ['deleted_date']
        db.create_index('accounts_user', ['deleted_date'])


    def backwards(self, orm):
        # Removing index on 'User', fields ['deleted_date']
        db.delete_index('accounts_user', ['deleted_date'])

        # Removing index on 'InviteRequest', fields ['deleted_date']
        db.delete_index('accounts_inviterequest', ['deleted_date'])

        # Removing index on 'UserWhitelist', fields ['deleted_date']
        db.delete_index('accounts_userwhitelist', ['deleted_date'])

        # Removing index on 'Payout', fields ['deleted_date']
        db.delete_index('accounts_payout', ['deleted_date'])
